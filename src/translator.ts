...
export const AlternateFormsDico: { [englishName: string]: string; } = {
	"Hoenn": "Hoenn",
	"Sinnoh": "Sinnoh",
	"Unova": "Unys",
	"Kalos": "Kalos",
	...
	"Violet": "Violet",
	"Busted": "Démasqué",
	"Busted-Totem": "Dominant-Démasqué",
	"Dawn-Wings": "Aurore",
	"Dusk-Mane": "Couchant",
	"Gorging": "Gobe-Chu",
	"Gulping": "Gobe-Tout",
	"Low-Key": "Grave",
	"Low-Key-Gmax": "Gmax-Grave",
	"Antique": "Antique",
	"Ruby-Cream": "Lait-Ruby",
	"Matcha-Cream": "Lait-Matcha",
	"Mint-Cream": "Lait-Menthe",
	"Lemon-Cream": "Lait-Citron",
	"Salted-Cream": "Lait-Salé",
	"Ruby-Swirl": "Mélange-Ruby",
	"Caramel-Swirl": "Mélange-Caramel",
	"Rainbow-Swirl": "Mélange-Tricolore",
	"Noice": "Tête Dégel",
	"Hangry": "Affamé",
	"Crowned": "Zacian:Épée|Zamazenta:Bouclier",
	"Eternamax": "Infinimax",
	"Rapid-Strike": "Mille-Poings",
	"Rapid-Strike-Gmax": "Gmax-Mille-Poings",
	"Dada": "Papa",
	"Shadow": "Effroi"
}
